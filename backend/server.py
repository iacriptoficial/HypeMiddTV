        ...
        if order_executed:
            ...
            if tp3_price or tp3_perc:
                ...
                try:
                    ...
                    await log_message("INFO", f"🎯 Placing TP3: {'BUY' if tp_is_buy else 'SELL'} {tp3_size} {symbol} at ${formatted_tp_price} (value: ${order_value:.2f})")
            ...
            if tp4_price or tp4_perc:
                ...
                try:
                    ...
                    await log_message("INFO", f"🎯 Placing TP4: {'BUY' if tp_is_buy else 'SELL'} {tp4_size} {symbol} at ${formatted_tp_price} (value: ${order_value:.2f}) (COMPLETE EXIT)")
