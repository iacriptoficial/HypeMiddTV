        ...
        if order_executed:
            ...
            if tp1_price or tp1_perc:
                ...
                try:
                    ...
                    await log_message("INFO", f"🎯 Placing TP1: {'BUY' if tp_is_buy else 'SELL'} {tp1_size} {symbol} at ${formatted_tp_price} (value: ${order_value:.2f})")
            ...
            if tp2_price or tp2_perc:
                ...
                try:
                    ...
                    await log_message("INFO", f"🎯 Placing TP2: {'BUY' if tp_is_buy else 'SELL'} {tp2_size} {symbol} at ${formatted_tp_price} (value: ${order_value:.2f})")
